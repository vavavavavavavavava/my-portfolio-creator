...
### 2. マイポートフォリオエディタからプロンプトをコピーする

1. `editor.html`をWebブラウザで開きます
2. 「プロンプトをコピー」ボタンをクリックします
3. 生成AIへの入力用プロンプトがクリップボードにコピーされます

### 3. 生成AIへのプロンプトを作成する

コピーしたプロンプトを生成AIの入力欄に貼り付け、末尾の「私の経歴情報」を自分の内容に置き換えます。以下は記入例です。
...
1. `editor.html`に戻り、「JSONを編集」ボタンをクリックします
